...
folder are mapped to the application's root namespace, 'TutorialApp1'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "TutorialApp1"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'TutorialApp1' in the same way
as `"TutorialApp1/sass/src"`.
